...
const processes = [{
  ...
  steps: ["Industry-specific algorithm development", "Analytics model training with domain data", "Real-time analytics implementation", "Insight delivery optimization"]
}, {
  id: 4,
