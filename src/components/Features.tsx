...
const Features = () => {
  ...
  const features = [
    {
      ...
      description: "Streamline workflows, eliminate bottlenecks, and boost productivity through data-driven process improvements.",
      image: "/lovable-uploads/29b4ace9-ea4f-470d-b5f3-dabe56a22125.png"
    },
    {
      icon: <Shield className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Process Integration & Simplification",
      description: "Break down silos and create seamless workflows that connect people, systems, and objectives.",
      image: "/lovable-uploads/556f2f04-46cc-4e62-94d7-63833f7cd3c9.png"
    },
    {
      icon: <HardHat className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Team Enablement & Technology",
      description: "Empower your teams with the right tools, training, and frameworks to sustain operational excellence.",
      image: "/lovable-uploads/07a608c7-85d1-4a2f-b470-ff0790e3523b.png"
    },
    {
      icon: <Zap className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Performance Measurement",
      description: "Implement robust metrics and KPIs that provide clear visibility into operational effectiveness and ROI.",
      image: "/lovable-uploads/2649b8f8-d196-42f8-a5cb-64090f210404.png"
    }
  ];
  ...
  const businessCaseStudies = [{
    ...
    description: "Streamlined production workflows increased output by 35% while reducing waste and improving quality control."
  }, {
    image: "/lovable-uploads/5463c9c5-0946-4280-a14b-17636ff69a98.png",
    title: "SME Digital Transformation",
    description: "Integrated technology solutions helped a 150-person company reduce operational costs by 28% in 12 months."
  }, {
    image: "/lovable-uploads/c5f8ee24-9815-4ebe-b65d-6f3d449feb8b.png",
    title: "Service Optimization",
    description: "Process redesign and team enablement improved customer satisfaction scores by 40% while reducing response times."
  }];
  const stepFlowItems = [{
    icon: <Microchip className="h-10 w-10 text-gray-700" />,
    title: "Process Discovery & Analysis",
    description: "Deep dive into your current operations to identify improvement opportunities"
  }, {
    icon: <Factory className="h-10 w-10 text-gray-700" />,
    title: "Integrated Solution Design",
    description: "Custom solutions that align people, processes, and technology"
  }, {
    icon: <Handshake className="h-10 w-10 text-gray-700" />,
    title: "Co-Working Implementation",
    description: "We work alongside your teams to ensure sustainable change"
  }];
  const sprintPhases = [{
    name: "Planning",
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8" ref={featuresRef}> 
          <div className="text-center mb-10 max-w-3xl mx-auto feature-item">
            ...
            <p className="text-gray-600 mt-4">
              Reforzo's integrated approach combines people, processes, and technology to deliver operational excellence that drives measurable business results.
            </p>
          </div>
              ...
              <div 
                ...
                className={cn(
                  ...
                  isHijacked 
                    ...
                    : "hover:-translate-y-1 hover:scale-105 h-[280px]"
                )}
                style={{
          ...
          <div className="mt-16 mb-8 feature-item">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
                See how Reforzo's integrated approach delivers measurable improvements across different business contexts, 
                from manufacturing to service delivery and digital transformation.
            ...
            <div className="rounded-xl overflow-hidden bg-white p-4 feature-item">
              <Carousel className="w-full max-w-7xl mx-auto">
                <CarouselContent className="flex">
                  {businessCaseStudies.map((study, index) => <CarouselItem key={index} className="md:basis-1/3 flex-shrink-0">
              ...
              <div className="text-center mt-6 text-sm text-gray-600">
                <p className="font-medium">These examples showcase just a few ways Reforzo delivers measurable business results</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="technology" className="bg-gray-50 py-10 md:py-16">
        <div className="w-full px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mb-4">How our integrated approach works</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Reforzo combines proven methodologies with customized solutions, 
              enabling us to deliver sustainable operational improvements at speed and scale.
            </p>
          </div>
              ...
              {stepFlowItems.map((item, index) => <HoverCard key={index}>
                  ...
                  <HoverCardContent className="w-80 shadow-lg">
                    <div className="space-y-2">
                      ...
                      {index === 0 && <p className="text-xs text-gray-500">We start by understanding your unique challenges and operational landscape.</p>}
                      {index === 1 && <p className="text-xs text-gray-500">We design holistic solutions that address root causes, not just symptoms.</p>}
                      {index === 2 && <p className="text-xs text-gray-500">We ensure knowledge transfer and capability building for long-term success.</p>}
                    </div>
                  </HoverCardContent>
                </HoverCard>)}
            </div>
