...
const projects = [
  {
    ...
    brand: "European Auto Parts Manufacturer",
    description: "Integrated operational transformation reduced production costs by 32% while improving quality metrics and employee satisfaction across 3 facilities.",
    tags: ["Manufacturing", "Cost Reduction", "Quality", "Process Optimization"],
    imageUrl: "/lovable-uploads/93ab0638-8190-4ccf-897f-21fda7f4f5ad.png",
    isFeatured: true,
    link: "/projects/firecat",
    details: `
      European Auto Parts Manufacturer faced rising costs and quality issues. Reforzo delivered an integrated transformation combining lean manufacturing principles, technology integration, and team enablement. Results: 32% cost reduction, 45% improvement in first-pass quality, 28% increase in employee engagement scores, and sustainable processes that continue to deliver benefits 18 months post-implementation.
    `
  },
  {
    id: 2,
    title: "Digital-First Service Transformation",
    brand: "Financial Services SME",
    description: "End-to-end process redesign and technology implementation reduced client onboarding time by 60% while improving compliance and customer satisfaction.",
    tags: ["Digital Transformation", "Process Design", "Financial Services", "Customer Experience"],
  ...
  },
  {
    ...
    brand: "Multi-National Retail Corporation",
    description: "Integrated supply chain redesign combining process improvement, technology deployment, and vendor management reduced inventory costs by 25%.",
    tags: ["Supply Chain", "Inventory Management", "Cost Optimization", "Vendor Relations"],
  ...
  },
  {
    ...
    brand: "Tech Startup Scale-Up",
    description: "Complete sales operation transformation including CRM implementation, process standardization, and team training increased conversion rates by 40%.",
    tags: ["Sales Operations", "CRM", "Team Training", "Performance Tracking"],
    imageUrl: "/lovable-uploads/c30e0487-2fa0-41d1-9a0b-699cb2855388.png",
    link: "/projects/hockey"
  },
  {
    id: 5,
    title: "Healthcare Process Innovation",
    brand: "Regional Healthcare Provider",
    description: "Patient flow optimization and staff efficiency improvements reduced wait times by 50% while maintaining quality of care standards.",
    tags: ["Healthcare", "Patient Experience", "Staff Efficiency", "Quality Care"],
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className={`text-center mb-10 max-w-3xl mx-auto transition-all duration-1000 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-gray-600">
            Discover how Reforzo's integrated approach transforms operational challenges into competitive advantages across different business contexts.
          </p>
          {isMobile && (
