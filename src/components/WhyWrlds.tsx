      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        margin: "-100px"
          ...
          <motion.p variants={itemVariants} className="text-gray-600 text-lg max-w-3xl mx-auto">
            In a market saturated with consultants and software, we deliver the integrated approach that actually drives results
          </motion.p>
        </motion.div>
        ...
        margin: "-100px"
          ...
          <motion.div variants={itemVariants} className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all">
            ...
            <p className="text-gray-700">Of businesses struggle with operational inefficiencies that impact their bottom line and growth potential</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all">
            ...
            <p className="text-gray-700">
              Of change initiatives fail due to lack of integration between people, processes, and technology
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all">
            ...
            <p className="text-gray-700">
              Average productivity increase achieved by companies that implement integrated operational improvements
            </p>
          </motion.div>
        </motion.div>
        ...
        <motion.div className="mb-12" initial="hidden" whileInView="visible" viewport={{
          ...
          <motion.div variants={itemVariants} className="text-center mb-8">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
              What Reforzo Does for You
            </h3>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We deliver measurable operational improvements that drive productivity, reduce costs, and accelerate growth
            </p>
          </motion.div>
          ...
          <motion.div variants={containerVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div variants={itemVariants} className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Streamline processes to reduce costs while improving quality and speed.</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Build organizational capabilities that support long-term competitive advantage.</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-xl font-bold text-gray-900 mb-2">Measurable ROI</h4>
                  <p className="text-gray-700">Every initiative delivers quantifiable results with clear return on investment.</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-xl font-bold text-gray-900 mb-2">Team Empowerment</h4>
                  <p className="text-gray-700">We build internal capabilities so your teams can sustain and evolve improvements.</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
