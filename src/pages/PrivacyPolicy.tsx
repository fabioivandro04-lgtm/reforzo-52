...
const PrivacyPolicy = () => {
  ...
  return (
    <PageLayout>
      <SEO 
        title="Privacy Policy - Reforzo" 
        description="Read Reforzo's privacy policy to understand how we collect, use, and protect your personal information."
        keywords={['privacy policy', 'data protection', 'reforzo privacy', 'information security']}
      />
      {/* Hero Section */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
                Your privacy and data protection are fundamental to our relationship with you.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                At Reforzo ("we," "our," or "us"), we respect your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
              </p>
              ...
              <ul className="list-disc pl-6 mb-4 text-gray-600">
                ...
                <li>Participate in our surveys or consultations</li>
              </ul>
              <p className="text-gray-600 mb-4">
              ...
              <ul className="list-disc pl-6 mb-4 text-gray-600">
                ...
                <li>Develop new methodologies, services, and features</li>
                <li>Communicate with you about our services, updates, and insights</li>
              ...
              <p className="text-gray-600 mb-4">If you have any questions about this Privacy Policy, please contact us at hello@reforzo.com</p>
            </motion.div>
          </div>
        </div>
      </section>
