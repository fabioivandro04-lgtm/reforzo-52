...
const ResolveService = () => {
  return (
    <PageLayout>
      ...
      <section className="relative pt-20 pb-24 bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 overflow-hidden">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 rounded-lg p-4 space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className="bg-green-500/20 text-green-300">Auto-Tagged</Badge>
                    </div>
                    <div className="h-2 bg-gray-700 rounded-full">
                      <div className="h-2 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-full w-3/4"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Support, <span className="text-blue-600">Solved.</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-16">
              How Re:Solve <span className="text-blue-400">Works</span> in Your Inbox
            </h2>
            ...
            <div className="space-y-12">
              <div className="flex items-start space-x-8">
                <div className="flex-shrink-0">
                  ...
                  <div className="w-px h-16 bg-gradient-to-b from-blue-500 to-transparent mx-auto mt-4"></div>
                </div>
              ...
              <div className="flex items-start space-x-8">
                <div className="flex-shrink-0">
                  ...
                  <div className="w-px h-16 bg-gradient-to-b from-purple-500 to-transparent mx-auto mt-4"></div>
                </div>
                <div className="flex-1">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 text-center mb-16">
              Power Up Your <span className="text-blue-600">Gmail Inbox</span>
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="md:col-span-2 p-8 bg-gradient-to-br from-blue-600 to-blue-700 text-white hover:shadow-2xl transition-all duration-300">
                <CardContent className="p-0">
                  <Zap className="w-12 h-12 text-blue-200 mb-4" />
                  <h3 className="text-xl font-bold mb-3">Automated Response Suggestions</h3>
                  <p className="text-blue-100">Instant, relevant reply suggestions for frequent inquiries that save hours of typing.</p>
                </CardContent>
              </Card>
              ...
              <Card className="md:col-span-2 p-8 bg-gradient-to-br from-purple-600 to-pink-600 text-white hover:shadow-2xl transition-all duration-300">
                <CardContent className="p-0">
                  <BarChart3 className="w-12 h-12 text-purple-200 mb-4" />
                  <h3 className="text-xl font-bold mb-3">Performance Insights</h3>
                  <p className="text-purple-100">Track response times, resolution rates, and identify trends in customer inquiries.</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 text-center mb-16">
              Why Use <span className="text-blue-600">Re:Solve?</span>
            </h2>
            ...
            <div className="space-y-12">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-100 p-8 rounded-2xl order-1 lg:order-2">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Perfect <span className="text-blue-400">For:</span>
            </h2>
      ...
      <section className="relative py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-96 h-96 bg-blue-400/20 rounded-full -translate-x-48 -translate-y-48"></div>
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-purple-400/20 rounded-full translate-x-48 translate-y-48"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg" 
                className="bg-white text-blue-600 hover:bg-gray-50 px-10 py-4 text-lg font-semibold group"
              >
                Add to Gmail
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Button>
